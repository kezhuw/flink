...
/**
 * A stream source function that returns a sequence of elements which could be not serializable.
 *
...
public class FromElementsFunction<T>
    ...
    private static <OUT> void checkIterable(Iterable<OUT> elements, Class<OUT> viewedAs) {
